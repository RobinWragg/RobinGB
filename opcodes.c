...
void robingb_execute_next_opcode(u8 *num_cycles_out) {
	...
	switch (opcode) {
		...
		case 0x01: DEBUG_set_opcode_name("LD BC,xx"); registers.bc = mem_read_u16(registers.pc+1); robingb_finish_instruction(3, 12); break;
		case 0x02: DEBUG_set_opcode_name("LD (BC),A"); mem_write(registers.bc, registers.a); robingb_finish_instruction(1, 8); break;
		...
		case 0x06: DEBUG_set_opcode_name("LD B,x"); registers.b = mem_read(registers.pc+1); robingb_finish_instruction(2, 8); break;
		...
		case 0x08: DEBUG_set_opcode_name("LD (xx),SP"); mem_write_u16(mem_read_u16(registers.pc+1), registers.sp); robingb_finish_instruction(3, 20); break;
		case 0x09: DEBUG_set_opcode_name("ADD HL,BC"); instruction_ADD_HL_u16(registers.bc); break;
		case 0x0a: DEBUG_set_opcode_name("LD A,(BC)"); registers.a = mem_read(registers.bc); robingb_finish_instruction(1, 8); break;
		...
		case 0x0e: DEBUG_set_opcode_name("LD C,x"); registers.c = mem_read(registers.pc+1); robingb_finish_instruction(2, 8); break;
		...
		on it. */
		case 0x11: DEBUG_set_opcode_name("LD DE,xx"); registers.de = mem_read_u16(registers.pc+1); robingb_finish_instruction(3, 12); break;
		case 0x12: DEBUG_set_opcode_name("LD (DE),A"); mem_write(registers.de, registers.a); robingb_finish_instruction(1, 8); break;
		...
		case 0x16: DEBUG_set_opcode_name("LD D,x"); registers.d = mem_read(registers.pc+1); robingb_finish_instruction(2, 8); break;
		...
		case 0x18: DEBUG_set_opcode_name("JR %i(d)"); robingb_finish_instruction(2 + (s8)mem_read(registers.pc+1), 12); break;
		case 0x19: DEBUG_set_opcode_name("ADD HL,DE"); instruction_ADD_HL_u16(registers.de); break;
		case 0x1a: DEBUG_set_opcode_name("LD A,(DE)"); registers.a = mem_read(registers.de); robingb_finish_instruction(1, 8); break;
		...
		case 0x1e: DEBUG_set_opcode_name("LD E,x"); registers.e = mem_read(registers.pc+1); robingb_finish_instruction(2, 8); break;
		...
		case 0x20: { DEBUG_set_opcode_name("JR NZ,s");
			...
			else robingb_finish_instruction(2 + (s8)mem_read(registers.pc+1), 12);
		} break;
		case 0x21: DEBUG_set_opcode_name("LD HL,xx"); registers.hl = mem_read_u16(registers.pc+1); robingb_finish_instruction(3, 12); break;
		case 0x22: DEBUG_set_opcode_name("LD (HL+),A"); mem_write(registers.hl++, registers.a); robingb_finish_instruction(1, 8); break;
		...
		case 0x28: { DEBUG_set_opcode_name("JR Z,s");
			if (registers.f & FLAG_Z) robingb_finish_instruction(2 + (s8)mem_read(registers.pc+1), 12);
			else robingb_finish_instruction(2, 8);
		} break;
		case 0x29: DEBUG_set_opcode_name("ADD HL,HL"); instruction_ADD_HL_u16(registers.hl); break;
		case 0x2a: DEBUG_set_opcode_name("LD A,(HL+)"); registers.a = mem_read(registers.hl++); robingb_finish_instruction(1, 8); break;
		...
		case 0x2e: DEBUG_set_opcode_name("LD L,x"); registers.l = mem_read(registers.pc+1); robingb_finish_instruction(2, 8); break;
		...
		case 0x30: { DEBUG_set_opcode_name("JR NC,s");
			if ((registers.f & FLAG_C) == 0) robingb_finish_instruction(2 + (s8)mem_read(registers.pc+1), 12);
			else robingb_finish_instruction(2, 8);
		} break;
		case 0x31: DEBUG_set_opcode_name("LD SP,xx"); registers.sp = mem_read_u16(registers.pc+1); robingb_finish_instruction(3, 12); break;
		case 0x32: DEBUG_set_opcode_name("LD (HL-),A"); mem_write(registers.hl--, registers.a); robingb_finish_instruction(1, 8); break;
		...
		case 0x36: DEBUG_set_opcode_name("LD (HL),x"); mem_write(registers.hl, mem_read(registers.pc+1)); robingb_finish_instruction(2, 12); break;
		...
		case 0x38: { DEBUG_set_opcode_name("JR C,s");
			if (registers.f & FLAG_C) robingb_finish_instruction(2 + (s8)mem_read(registers.pc+1), 12);
			else robingb_finish_instruction(2, 8);
		} break;
		case 0x39: DEBUG_set_opcode_name("ADD HL,SP"); instruction_ADD_HL_u16(registers.sp); break;
		case 0x3a: DEBUG_set_opcode_name("LD A,(HL-)"); registers.a = mem_read(registers.hl--); robingb_finish_instruction(1, 8); break;
		...
		case 0x3e: DEBUG_set_opcode_name("LD A,x"); registers.a = mem_read(registers.pc+1); robingb_finish_instruction(2, 8); break;
		...
		case 0x46: DEBUG_set_opcode_name("LD B,(HL)"); registers.b = mem_read(registers.hl); robingb_finish_instruction(1, 8); break;
		...
		case 0x4e: DEBUG_set_opcode_name("LD C,(HL)"); registers.c = mem_read(registers.hl); robingb_finish_instruction(1, 8); break;
		...
		case 0x56: DEBUG_set_opcode_name("LD D,(HL)"); registers.d = mem_read(registers.hl); robingb_finish_instruction(1, 8); break;
		...
		case 0x5e: DEBUG_set_opcode_name("LD E,(HL)"); registers.e = mem_read(registers.hl); robingb_finish_instruction(1, 8); break;
		...
		case 0x66: DEBUG_set_opcode_name("LD H,(HL)"); registers.h = mem_read(registers.hl); robingb_finish_instruction(1, 8); break;
		...
		case 0x6e: DEBUG_set_opcode_name("LD L,(HL)"); registers.l = mem_read(registers.hl); robingb_finish_instruction(1, 8); break;
		case 0x6f: DEBUG_set_opcode_name("LD L,A"); registers.l = registers.a; robingb_finish_instruction(1, 4); break;
		case 0x70: DEBUG_set_opcode_name("LD (HL),B"); mem_write(registers.hl, registers.b); robingb_finish_instruction(1, 8); break;
		case 0x71: DEBUG_set_opcode_name("LD (HL),C"); mem_write(registers.hl, registers.c); robingb_finish_instruction(1, 8); break;
		case 0x72: DEBUG_set_opcode_name("LD (HL),D"); mem_write(registers.hl, registers.d); robingb_finish_instruction(1, 8); break;
		case 0x73: DEBUG_set_opcode_name("LD (HL),E"); mem_write(registers.hl, registers.e); robingb_finish_instruction(1, 8); break;
		case 0x74: DEBUG_set_opcode_name("LD (HL),H"); mem_write(registers.hl, registers.h); robingb_finish_instruction(1, 8); break;
		case 0x75: DEBUG_set_opcode_name("LD (HL),L"); mem_write(registers.hl, registers.l); robingb_finish_instruction(1, 8); break;
		...
		case 0x77: DEBUG_set_opcode_name("LD (HL),A"); mem_write(registers.hl, registers.a); robingb_finish_instruction(1, 8); break;
		...
		case 0x7e: DEBUG_set_opcode_name("LD A,(HL)"); registers.a = mem_read(registers.hl); robingb_finish_instruction(1, 8); break;
		...
		case 0xd6: DEBUG_set_opcode_name("SUB x"); instruction_SUB_u8(mem_read(registers.pc+1), 2, 8); break;
